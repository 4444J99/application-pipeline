...
from fix_json_metrics import fix_json_metrics
...
def test_fix_json_metrics(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("fix_json_metrics.PROFILES_DIR", profiles_dir)
    monkeypatch.setattr("fix_json_metrics.OLD_VAL", "42")
    monkeypatch.setattr("fix_json_metrics.NEW_VAL", "47")
