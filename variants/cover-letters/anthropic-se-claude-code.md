...
- **agentic-titan:** 1,276 tests, multi-agent orchestration (organvm-iv-taxis/agentic-titan)
- **recursive-engine:** 1,254 tests, 85% coverage, symbolic DSL design (organvm-i-theoria/recursive-engine--generative-entity)
- **linguistic-atomization-framework:** 142 tests, language decomposition and composable DSL design (organvm-i-theoria/linguistic-atomization-framework)
- **agent--claude-smith:** Multi-agent system built on Claude Agent SDK — TypeScript, session persistence, self-correction hooks (organvm-iv-taxis/agent--claude-smith)
