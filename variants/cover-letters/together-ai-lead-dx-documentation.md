...
**LLM and AI application experience.** agentic-titan is a multi-agent orchestration framework with 1,276 tests across Python, Rust, and TypeScript adapters, a CLI interface, and Redis-backed coordination — the kind of complex API surface that needs great documentation to be usable. recursive-engine implements a symbolic operating system with a custom DSL, 21 organ handlers, and 1,254 tests. I understand LLM APIs — tool-use, chaining, structured outputs, function calling — because I've built production systems that depend on them.
