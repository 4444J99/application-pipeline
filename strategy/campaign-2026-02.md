...
| Entry | Status | Fit | Effort |
|-------|--------|-----|--------|
| Processing Foundation Fellowship | `staged` | 6.5 | standard |
| Tulsa Artist Fellowship | `staged` | 6.8 | complex |
...
| Entry | Status | Fit | Effort |
|-------|--------|-----|--------|
| Fractured Atlas Fiscal Sponsorship | `staged` | 7.1 | quick |
| GitHub Sponsors | `staged` | 7.1 | quick |
| Lambda Literary Retreat | `staged` | 7.2 | quick |
| NEW INC (New Museum) | `staged` | 7.2 | standard |
| Queer|Art Mentorship | `staged` | 7.1 | standard |

### Residency

| Entry | Status | Fit | Effort |
|-------|--------|-----|--------|
| Eyebeam Speculating on Plurality | `staged` | 7.3 | standard |
| Google Creative Lab Five | `staged` | 8.5 | standard |
| Pioneer Works | `staged` | 7.2 | standard |
