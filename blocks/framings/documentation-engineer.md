...
- **Scale:** ~741K+ words of structured documentation across 116 repos — not padded prose, but architecture plans, SOPs, session logs, governance rules, registry data, and generated context files
...
- organvm-corpvs-testamentvm: ~741K+ words, validation scripts, 2,240-line registry-v2.json with JSON Schema
...
- "~741K+ words" includes generated/templated content, not all original prose
