...
> I built an eight-organ system that coordinates 113 repositories across 8 GitHub organizations — governing how theory, generative art, commercial products, and community work flow into each other through automated dependency validation, a promotion state machine, and ~739K+ words of public documentation. I'm most proud of it because it demonstrates that governance and art aren't separate categories: the rules that coordinate the system are as carefully designed as any artwork it produces. It's infrastructure that makes its own logic visible.
...
### Key fields:
- **Professional Writing Credentials:** MFA, 49 essays, ~739K+ words, 11 years teaching
